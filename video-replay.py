...
replay_node.stereo.setSubpixel(True)

manip = pipeline.create(dai.node.ImageManip)
manip.initialConfig.setResize(300,300)
manip.setMaxOutputFrameSize(300*300*3)
replay_node.color.out.link(manip.inputImage)
...
replay_node.stereo.depth.link(nn.inputDepth)
...
replay_node.stereo.disparity.link(depthOut.input)
...
with dai.Device(pipeline) as device:
    ...
    disparityMultiplier = 255 / replay_node.stereo.initialConfig.getMaxDisparity()
    color = (255, 0, 0)
